...
Rubric enforced (reference, not inlined): the audit report-design contract and `backend/docs/CONTENT-DOCTRINE.md` narrative discipline; the `GET /reports/types` tab map. Shared wiring + degrade contract: `${CLAUDE_PROJECT_DIR}/.claude/skills/_shared/reference/`.
