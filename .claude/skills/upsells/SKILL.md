...
Rubric enforced (reference, not inlined): the upsell catalogue model (fields + the 0.062 conversion estimate). Shared wiring + roles: `${CLAUDE_PROJECT_DIR}/.claude/skills/_shared/reference/`.
