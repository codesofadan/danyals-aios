...
2. **Read the profiles and stats.** Run `aios_client.py get "/local-seo/profiles?clientId=<id>"`
   ...
   `GET /local-seo/stats`. Fields: `${CLAUDE_PROJECT_DIR}/.claude/skills/_shared/reference/part8-output-formats.md` §5.
...
`${CLAUDE_PROJECT_DIR}/.claude/skills/_shared/reference/part8-output-formats.md` §5.
