...
Rubric enforced (reference, not inlined): the milestone stage model (the five-stage lifecycle + stage weights). Shared wiring: `${CLAUDE_PROJECT_DIR}/.claude/skills/_shared/reference/`.
