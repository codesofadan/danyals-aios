...
1. **Resolve the client and pull fresh context.**
   Run `python ${CLAUDE_PLUGIN_ROOT}/scripts/aios_client.py resolve-client --client "$client"`
...
Rubric enforced (reference, not inlined): `reference/CONTENT-DOCTRINE.md` §2 (E-E-A-T), §7
(differentiation angle), §8 (local anatomy + per-city uniqueness), §11 (14 QA dimensions).
Exact response fields: `reference/output-formats.md`.
