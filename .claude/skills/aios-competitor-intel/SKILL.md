...
2. **Read the board.** Run `aios_client.py get "/competitor-intel/competitors?clientId=<id>&tracked=true"`
   ...
   → `GET /competitor-intel/stats`. Fields: `${CLAUDE_PROJECT_DIR}/.claude/skills/_shared/reference/part8-output-formats.md` §3.
...
`${CLAUDE_PROJECT_DIR}/.claude/skills/_shared/reference/part8-output-formats.md` §3.
