...
export const upsells: Upsell[] = [
  {
    ...
    description: "High-authority, manually-placed editorial backlinks to build your site's authority — white-hat and safe.",
  ...
  },
  {
    ...
    description: "Accurate NAP citations across top local directories to strengthen your map-pack rankings.",
    fiverrUrl: "https://www.fiverr.com/iamdaani",
    active: true,
    clicks30d: 203,
    price: 0,
