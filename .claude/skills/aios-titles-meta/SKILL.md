...
Rubric enforced (reference, not inlined): `${CLAUDE_PROJECT_DIR}/.claude/skills/_shared/reference/CONTENT-DOCTRINE.md` §9 (titles, meta,
media), §6 (4 U's), §11 (`keyword_handling`, `snippet_extractability`, `fact_grounding`). Exact
response fields: `${CLAUDE_PROJECT_DIR}/.claude/skills/_shared/reference/output-formats.md`.
